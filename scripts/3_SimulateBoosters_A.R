...
#install.packages("C:/Users/Edward/Desktop/odsc blogs/presentation/ODSC_west_2018/BoosterBox_0.0.2.tar.gz", repos = NULL, type = "source")

# Setwd
setwd("C:/Users/Edward/Desktop/odsc blogs/presentation/ODSC_west_2018/workshop_data/MTG")
...
guildsOfRavnica <- read.csv('Guilds.csv')
